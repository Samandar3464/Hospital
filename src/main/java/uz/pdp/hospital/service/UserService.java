...
import uz.pdp.hospital.config.jwtConfig.JwtGenerate;
...
import uz.pdp.hospital.model.request.*;
import uz.pdp.hospital.model.response.NotificationMessageResponse;
import uz.pdp.hospital.model.response.TokenResponse;
import uz.pdp.hospital.model.response.UserResponseDto;
import uz.pdp.hospital.model.response.UserResponseListForAdmin;
...
public class UserService implements BaseService<UserRegisterDto, Integer> {
    ...
    public ApiResponse create(UserRegisterDto dto) {
        ...
        Hospital hospital = hospitalRepository.findById(dto.getMarketId()).orElseThrow(() -> new RecordNotFoundException(MARKET_NOT_FOUND));
